...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("whatlearn.update", $model->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
                {{ method_field('PATCH') }}
...
<div class="col-sm-8"><input type="text" class="form-control" name="detail" value="{{ $model->detail }}" placeholder="Enter detail">
