...
@section('title', 'Add New Institute')
@push('css')
    <style>
        select {
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("institute.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
					...
					<div class="box-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-8 input-group" style="margin-left:225px !important">
                                <input type="text" class="form-control" name="skill[]" id="skills" value="{{ old('skills') }}" data-role="tagsinput" placeholder="Write skill & enter">
						...
						<div class="col-sm-8"><textarea class="form-control" id="address" name="address" placeholder="Enter address">{{ old("address") }}</textarea>
						...
						<div class="col-sm-8"><input type="text" class="form-control" name="affilated_by" value="{{ old("affilated_by") }}" placeholder="Enter affilated_by">
						...
						<div class="col-sm-8"><textarea class="form-control ckeditor" id="about" name="about" placeholder="Enter about">{{ old("about") }}</textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" name="is_verified">
									<option value="1" {{ old("is_verified")==1?"selected":"" }}>Active</option>
									<option value="0" {{ old("is_verified")==0?"selected":"" }}>In Active</option>
								</select>
