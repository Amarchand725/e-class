...
@section('title', 'Add New CourseChapter')
@push('css')
    <style>
        select {
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("coursechapter.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
...
<div class="col-sm-8"><input type="text" class="form-control" name="file" value="{{ old("file") }}" placeholder="Enter file">
