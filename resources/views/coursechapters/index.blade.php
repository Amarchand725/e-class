...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="{{ route('coursechapter.create') }}" data-toggle="tooltip" data-placement="left" title="Add New CourseChapter" class="btn btn-primary btn-sm">Add New CourseChapter</a>
    </div>
</section>
