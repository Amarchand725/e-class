...
@section('title', 'Edit Coursequestion')
@push('css')
    <style>
        select {
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("coursequestion.update", $model->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
                {{ method_field('PATCH') }}
...
<div class="col-sm-8"><textarea class="form-control" id="question" name="question">{{ $model->question }}</textarea>
