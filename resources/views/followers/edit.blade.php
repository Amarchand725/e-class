...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("follower.update", $model->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
                {{ method_field('PATCH') }}
...
<div class="col-sm-8"><input type="number" class="form-control" name="follower_id" value="{{ $model->follower_id }}" placeholder="Enter follower_id">
...
<div class="col-sm-8"><input type="number" class="form-control" name="following_id" value="{{ $model->following_id }}" placeholder="Enter following_id">
