...
@section('title', 'Add New Wishlist')
@push('css')
    <style>
        select {
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("wishlist.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
...
<div class="col-sm-8"><input type="number" class="form-control" name="live_meeting_id" value="{{ old("live_meeting_id") }}" placeholder="Enter live_meeting_id">
