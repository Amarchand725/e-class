...
@section('title', 'Add New Courseinclude')
@push('css')
    <style>
        select {
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("courseinclude.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				<div class="box box-info">
					<div class="box-body">
                        <div class="form-group">
<label for="course_id" class="col-sm-2 control-label">Course_id <span style="color:red">*</span></label>
<div class="col-sm-8"><input type="number" class="form-control" name="course_id" value="{{ old("course_id") }}" placeholder="Enter course_id">
...
<div class="col-sm-8"><input type="text" class="form-control" name="icon" value="{{ old("icon") }}" placeholder="Enter icon">
