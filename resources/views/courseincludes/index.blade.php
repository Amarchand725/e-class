...
@section('content')
<input type="hidden" id="page_url" value="{{ route('courseinclude.index') }}">
<section class="content-header">
    <div class="content-header-left">
        <h1>{{ $page_title }}</h1>
    </div>
    <div class="content-header-right">
        <a href="{{ route('courseinclude.create') }}" data-toggle="tooltip" data-placement="left" title="Add New Courseinclude" class="btn btn-primary btn-sm">Add New Courseinclude</a>
    </div>
</section>
                ...
                <div class="box-body">
                    ...
                    <table id="" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>SL</th>
                                <th>COURSE_ID</th><th>ICON</th><th>DETAIL</th><th>STATUS</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody id="body">
