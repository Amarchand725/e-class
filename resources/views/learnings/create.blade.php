...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route("learning.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				<div class="box box-info">
					<div class="box-body">
                        ...
                        <div class="col-sm-8"><input type="text" class="form-control" name="label" value="{{ old("label") }}" placeholder="Enter label">
                        <span style="color: red">{{ $errors->first("label") }}</span></div></div><div class="form-group">
                        <label for="message" class="col-sm-2 control-label">Message</label>
                        <div class="col-sm-8"><textarea class="form-control" id="message" name="message" placeholder="Enter message">{{ old("message") }}</textarea>
