            ...
            <div class="newsletter-block">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7">
                        <form class="email-subscribe" id="email-subscribe" data-action="<?php echo e(route('user.email_subscribe')); ?>">
                            <input type="email" placeholder="Enter your email address" id="subscribed_email" name="subscribed_email">
                            <span style="color: white" id="error-subscribed_email"><?php echo e($errors->first('subscribed_email')); ?></span>
                ...
                <div class="col-lg-4 col-md-4 col-12">   
                    <div class="footer-logo">
                        <a href="<?php echo e(route('home')); ?>" title="logo">
                            <img src="<?php echo e(asset('public/website/images/logo/footer_logo.png')); ?>" alt="logo" class="img-fluid" >
                        </a>
                    </div>

                    <div class="mobile-btn">
                        <a href="https://facebook.com/" title="">
                            <img src="<?php echo e(asset('public/website/images/icons/download-google-play.png')); ?>" alt="logo">
                        </a>
                        <a href="https://facebook.com/" title=""><img src="<?php echo e(asset('public/website/images/icons/app-download-ios.png')); ?>" alt="logo"></a>
                    </div>
                </div>
...
</footer><?php /**PATH C:\xampp\htdocs\e-learning-system\resources\views/web-views/layouts/footer.blade.php ENDPATH**/ ?>