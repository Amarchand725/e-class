                        ...
                        <div class="panel panel-sum">
                            <div class="modal-body">
                                <div class="box box-primary">
                                    <div class="panel panel-sum">
                                        <div class="modal-body">
                                            <form id="become-instructor-form" method="post" data-action="<?php echo e(route('user.store')); ?>" data-parsley-validate="" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-6">
