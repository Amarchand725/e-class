                    ...
                    <table id="" class="table table-bordered table-striped">
                        ...
                        <tbody id="body">
                            ...
                            <tr id="id-<?php echo e($model->id); ?>">
                                    ...
                                    <td><?php echo e($model->country_code); ?></td>
                                    ...
                                    <td width="250px">
                                        ...
                                        <a href="<?php echo e(route("country.edit", $model->id)); ?>" data-toggle="tooltip" data-placement="top" title="Edit Country" class="btn btn-primary btn-xs" style="margin-left: 3px;"><i class="fa fa-edit"></i> Edit</a>
                                        <button data-toggle="tooltip" data-placement="top" title="Delete Country" class="btn btn-danger btn-xs delete" data-slug="<?php echo e($model->id); ?>" data-del-url="<?php echo e(route("country.destroy", $model->id)); ?>" style="margin-left: 3px;"><i class="fa fa-trash"></i> Delete</button>
                                    </td>
                                </tr>
