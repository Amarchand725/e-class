                ...
                <div class="col-lg-6 col-md-6">
                    <div class="signup-heading">
                        ...
                        <div class="signup-block">
                            <form method="POST" class="signup-form" action="https://eclass.mediacity.co.in/demo/public/login">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-6">
                                        <div class="forgot-password text-right btm-20"><a href="password/reset.html" title="sign-up">ForgotPassword</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="sign-up text-center">Donothaveanaccount?<a href="register.html" title="sign-up"> Signup</a>
                            </div>
                            <hr>
...
<?php echo $__env->make('web-views.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-class\resources\views/web-views/auth/login.blade.php ENDPATH**/ ?>