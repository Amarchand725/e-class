                ...
                <div class="about-home-product">
                    <div class="video-item hidden-xs">
                        ...
                        <div class="video-device">
                            <img src="<?php echo e(asset('public/admin/bundle/banners')); ?>/<?php echo e($model->thumbnail); ?>" class="bg_img img-fluid" alt="Background">
                    ...
                    <div class="about-home-dtl-training">
                        <div class="about-home-dtl-block btm-10">
                            ...
                            <div class="about-home-btn btm-20">
                                <a href="<?php echo e(route('add.to.cart', $model->slug)); ?>" class="btn btn-primary btn-block text-center" role="button"><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;Subscribe Now</a>
                            </div>                        
                            <hr>
