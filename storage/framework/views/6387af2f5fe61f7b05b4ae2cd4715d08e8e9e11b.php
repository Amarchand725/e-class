			...
			<form action="<?php echo e(route("slider.store")); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="col-sm-8"><input type="text" class="form-control" name="sub_title" value="<?php echo e(old("sub_title")); ?>" placeholder="Enter sub_title">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-class\resources\views/sliders/create.blade.php ENDPATH**/ ?>