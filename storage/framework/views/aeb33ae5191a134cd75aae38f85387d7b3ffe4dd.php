        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-body">
                        <table class="table"><tr><th>Country</th><td><?php echo e($model->hasCountry->name); ?></td></tr><tr><th>Name</th><td><?php echo e($model->name); ?></td></tr><tr><th>Description</th><td><?php echo e($model->description); ?></td></tr><tr><th>Status</th><td><?php if($model->status): ?><span class="label label-success">Active</span><?php else: ?><span class="label label-danger">In-Active</span><?php endif; ?></td></tr></table>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-class\resources\views/states/show.blade.php ENDPATH**/ ?>