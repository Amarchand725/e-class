            ...
            <div class="row no-gutters">
                <div class="col-lg-4 col-sm-5">
                    <div class="recommendations-block">
                        <h4 class="recommendations-heading"> eClass-LearningManagementSystem</h4>
                        <p>Join us an instructor</p>
                    ...
                    <div id="recommendations-slider" class="recommendations-main-slider owl-carousel">
                        <div class="item">
                            <div class="recommendations-img">
                                <img src="<?php echo e(asset('public/website/images/joininstructor/1643950703instructor.jpg')); ?>" height="100px;" width="100px;" />
                            </div>
                        </div>
                    </div>
                </div>
...
</section><?php /**PATH C:\xampp\htdocs\e-learning-system\resources\views/web-views/layouts/recommendations.blade.php ENDPATH**/ ?>