    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form id="add-course-announcement-form" data-course-form="<?php echo e(route('courseannouncement.store')); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea id="announcement" class="form-control" name="announcement" placeholder="Enter announcement"><?php echo e(old('announcement')); ?></textarea>
                                        <span style="color: red" id="error-announcement"><?php echo e($errors->first("announcement")); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="switch">
                                            <input id="c_announcement_status" class="cmn-toggle cmn-toggle-round-flat" value="1" <?php if(old('status')): ?> checked <?php endif; ?> name="status" type="checkbox">
                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="announcement" class="col-sm-3 control-label">announcement <span style="color:red">*</span></label>
                                    <div class="col-sm-8">
                                        <textarea id="announcement" class="form-control" name="announcement" placeholder="Enter announcement"><?php echo e($model->announcement); ?></textarea>
                                        <span style="color: red" id="error-announcement"><?php echo e($errors->first("announcement")); ?></span>
                                    </div>
                                </div>
...
</div><?php /**PATH C:\xampp\htdocs\e-class\resources\views/web-views/website/courseincludes/announcements/modals.blade.php ENDPATH**/ ?>