                        ...
                        <div class="panel panel-sum">
                            <div class="modal-body">
                                <div class="box box-primary">
                                    <div class="panel panel-sum">
                                        <div class="modal-body">
                                            <form id="become-instructor-form" method="post" data-action="<?php echo e(route('user.store')); ?>" data-parsley-validate="" class="form-horizontal form-label-left instructor-popup regisger-form signup-form" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-6">
...
<?php /**PATH C:\xampp\htdocs\e-learning-system\resources\views/web-views/layouts/app.blade.php ENDPATH**/ ?>