                    ...
                    <table id="" class="table table-bordered table-striped">
                        ...
                        <tbody id="body">
                            ...
                            <tr id="id-<?php echo e($model->id); ?>">
                                    ...
                                    <td><?php echo e($model->profile_image); ?></td>
                                    <td><?php echo e($model->name); ?></td>
                                    <td><?php echo e($model->roles->first()->name??'N/A'); ?></td>
                                    ...
                                    <td width="250px">
                                        <a href="<?php echo e(route("userprofile.show", $model->id)); ?>" data-toggle="tooltip" data-placement="top" title="Show UserProfile" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Show</a>
                                        <a href="<?php echo e(route("userprofile.edit", $model->id)); ?>" data-toggle="tooltip" data-placement="top" title="Edit UserProfile" class="btn btn-primary btn-xs" style="margin-left: 3px;"><i class="fa fa-edit"></i> Edit</a>
                                        <button data-toggle="tooltip" data-placement="top" title="Delete UserProfile" class="btn btn-danger btn-xs delete" data-slug="<?php echo e($model->id); ?>" data-del-url="<?php echo e(route("userprofile.destroy", $model->id)); ?>" style="margin-left: 3px;"><i class="fa fa-trash"></i> Delete</button>
                                    </td>
                                </tr>
