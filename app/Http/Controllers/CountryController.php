...
class CountryController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax()){
            ...
            if($request['search'] != ""){
                $query->where("name", "like", "%". $request["search"] ."%");$query->orWhere("country_code", "like", "%". $request["search"] ."%");$query->orWhere("currency", "like", "%". $request["search"] ."%");$query->orWhere("currency_symbol", "like", "%". $request["search"] ."%");$query->orWhere("description", "like", "%". $request["search"] ."%");$query->orWhere("flag", "like", "%". $request["search"] ."%");
            }
